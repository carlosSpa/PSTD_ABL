...
We use the DAMPED WAVE EQUATION formulation to solve this problem.
The 600 simulations are defined varying the tuple (Nabl,sigma) in 30x20 different cases.
======================================================================================================================================================================
*/
#include <stdlib.h>
#include <stdio.h>
...
int main(){
	...
	for(int m=0;m<Nb;m++){
		...
		initParam(&D,Lx,Ly,Lz,Dx,Dt,S,Tiempo,nPML,sigma,0,Nb,Nparam);
		initArrays(&D);
		defineDomain(&D);
