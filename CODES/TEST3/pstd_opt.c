...
void defineDomain3D(domain* D,int malla){
    ...
    if(malla==0)
        r1=fopen("./Mallas2/Euler/3d.outRef.bin","rb");
    if(malla==1)
        r1=fopen("./Mallas2/Euler/3d.outAcc2_1.bin","rb");
    if(malla==2)
        r1=fopen("./Mallas2/Euler/3d.outAcc2_1.bin","rb");
    if(malla==3)
        r1=fopen("./Mallas2/Euler/3d.outAcc3.bin","rb");
    if(malla==4)
        r1=fopen("./Mallas2/Euler/3d.outAcc4.bin","rb");
    if(malla==5)
        r1=fopen("./Mallas2/Euler/3d.outAcc5.bin","rb");
    if(malla==6)
        r1=fopen("./Mallas2/Euler/3d.outAcc6.bin","rb");
    if(malla==7)
        r1=fopen("./Mallas2/Euler/3d.outAcc7.bin","rb");
...
void defineDomainDamped(domain* D,int malla){
  ...
  int nData;FILE *r1;double av;
    ...
    if(malla==1)
        r1=fopen("./Mallas2/Damped/3d.outAcc1.bin","rb");
    if(malla==2)
        r1=fopen("./Mallas2/Damped/3d.outAcc2.bin","rb");
    if(malla==3)
        r1=fopen("./Mallas2/Damped/3d.outAcc3.bin","rb");
    if(malla==4)
        r1=fopen("./Mallas2/Damped/3d.outAcc4.bin","rb");
    if(malla==5)
        r1=fopen("./Mallas2/Damped/3d.outAcc5.bin","rb");
    if(malla==6)
        r1=fopen("./Mallas2/Damped/3d.outAcc6.bin","rb");
    if(malla==7)
        r1=fopen("./Mallas2/Damped/3d.outAcc7.bin","rb");
...
void defineDomainSponge(domain* D,int malla){
    ...
    if(malla==1)
        r1=fopen("./Mallas2/Sponge/3d.outAcc1.bin","rb");
    if(malla==2)
        r1=fopen("./Mallas2/Sponge/3d.outAcc2.bin","rb");
    if(malla==3)
        r1=fopen("./Mallas2/Sponge/3d.outAcc3.bin","rb");
    if(malla==4)
        r1=fopen("./Mallas2/Sponge/3d.outAcc4.bin","rb");
    if(malla==5)
        r1=fopen("./Mallas2/Sponge/3d.outAcc5.bin","rb");
    if(malla==6)
        r1=fopen("./Mallas2/Sponge/3d.outAcc6.bin","rb");
    if(malla==7)
        r1=fopen("./Mallas2/Sponge/3d.outAcc7.bin","rb");
